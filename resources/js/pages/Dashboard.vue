...
<template>
    ...
    <DashboardLayout>
        <h4 class="fw-bold mb-4 py-3"><span class="text-muted fw-light">Dashboard /</span> Analytics</h4>
                    ...
                    <div class="d-flex align-items-end row">
                        <div class="col-sm-7">
                            <div class="card-body">
                                ...
                                <p class="mb-4">Anda berhasil masuk ke sistem. Mari mulai mengelola transaksi dan data bisnis Anda.</p>

                                <a href="javascript:;" class="btn btn-sm btn-outline-primary">Lihat Transaksi</a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h3 class="card-title mb-2">Rp 12,628,000</h3>
                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <span>Transaksi</span>
                                <h3 class="card-title mb-1 text-nowrap">156</h3>
                ...
                <div class="card h-100">
                    <div class="card-header d-flex align-items-center justify-content-between pb-0">
                        <div class="card-title mb-0">
                            <h5 class="m-0 me-2">Statistik Pesanan</h5>
                            ...
                            <div class="tab-pane fade show active" id="navs-tabs-line-card-income" role="tabpanel">
                                <div class="d-flex p-4 pt-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <h6 class="me-1 mb-0">Rp 459,100</h6>
                                ...
                                <div class="d-flex justify-content-center gap-2 pt-4">
                                    ...
                                    <div>
                                        ...
                                        <small class="text-muted">Rp 39k less than last week</small>
                                    </div>
                                </div>
                            </div>
                        </div>

                            ...
                            <form @submit.prevent="submit" class="mb-3">
                                <div class="form-password-toggle mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <span class="input-group-text cursor-pointer">
                                            <i :class="showPassword ? 'bx bx-hide' : 'bx bx-show'" @click="showPassword = !showPassword"></i>
                                        </span>
                                    </div>
                                ...
                                <div class="form-password-toggle mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <span class="input-group-text cursor-pointer">
                                            <i
                                                :class="showPasswordConfirmation ? 'bx bx-hide' : 'bx bx-show'"
                                ...
                                <button class="btn btn-primary d-grid mb-3 w-100" type="submit" :disabled="form.processing">
                                    <span

...
const form = useForm({
    ...
    biaya_produk: props.produk.biaya_produk.toString(),
    stok: props.produk.stok.toString(),
    batas_stok: props.produk.batas_stok.toString(),
});
...
const currentImage = computed(() => {
    if (props.produk.gambar) {
        return `/storage/${props.produk.gambar}`;
    }
    return null;
});
...
const submit = () => {
    form.put(route('produk.update', props.produk.id_produk));
};
</script>
...
<template>
    ...
    <DashboardLayout>
        <h4 class="fw-bold mb-4 py-3"><span class="text-muted fw-light">Manajemen / Produk /</span> Edit Produk</h4>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="id_produk" class="form-label">Kode Produk</label>
                                        <input id="id_produk" :value="produk.id_produk" type="text" class="form-control" readonly disabled />
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div v-else-if="currentImage" class="text-center">
                                ...
                                <img :src="currentImage" alt="Current Image" class="img-thumbnail" style="max-width: 200px; max-height: 200px" />
                            </div>

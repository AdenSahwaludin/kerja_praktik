<template>
    ...
    <DashboardLayout>
        <h4 class="fw-bold mb-4 py-3"><span class="text-muted fw-light">Manajemen / Produk /</span> Detail Produk</h4>
        ...
        <div class="card shadow-sm">
            <div class="row g-0">
                ...
                <div class="col-md-4">
                    ...
                    />
                    <div v-else class="d-flex align-items-center justify-content-center bg-light rounded-start h-100 w-100">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <p class="text-muted small mb-3">
                            Kode: <strong>{{ produk.id_produk }}</strong>
                        </p>
